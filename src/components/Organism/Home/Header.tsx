    ...
    <header className="flex flex-col">
      <div className="flex justify-between h-full items-center px-3 mb-3">
        ...
        <button className="flex h-full items-center">
          <p className="flex h-full text-black font-bold text-center justify-center items-center  xl:text-[3rem] lg:text-[2.75rem] md:text-[2.5rem] xl:mr-[1rem] lg:mr-[0.875rem] md:mr-[0.75rem]">
            #
          </p>
